...
public class LearningTool{
  ...
  public LearningTool(String duration, double[] prices, double eps){
  ...
  public double getThreeMonthLow(int duration){
  ...
  public double getThreeMonthHigh(int duration){
    double max = 0;
    for(int i = 0; i < duration; i++){
      if(max < prices[i]){
        max = prices[i];
  ...
  public double calcHistPERatio(int duration){
    double sumPrices = 0;
    for(int i = 0; i < duration; i++){
      sumPrices += prices[i];
    }
    
    double avePrice = sumPrices / duration;
    return avePrice / eps;
  }
  ...
  public String getPERatio(){
    ...
    double currentPE = calcPERatio();
    double histPE = calcHistPERatio(outlook);
  ...
  public double calcHistPrice(int duration){
    double sumPrices = 0;
    for(int i = 0; i < duration; i++){
      sumPrices += prices[i];
    }
    
    return sumPrices / duration;
  }
  ...
  public String getPrice(){
    ...
    double histPrice = calcHistPrice(outlook);
  ...
  public double calcMomentum(int start, int end){
  ...
  public String getMomentum(){
    ...
    double currentMom = calcMomentum(0, outlook);
    double histMom = calcMomentum(outlook, (outlook *2));
  ...
  public double calcRSI(int duration){
    double sumPosDays = 0;
    double sumNegDays = 0;
    int numPos = 0;
    for(int i = 0; i < duration; i++){
    ...
    double aveNegDays = sumNegDays / (duration - numPos);
  ...
  public double calcEMA(int duration){
  ...
  public String getEMA(){
    ...
    double currentEMA = calcEMA(outlook);
    double histEMA = calcEMA(outlook);
